      ...
      <div className="page-content">
        <div className="container">
          <div className="prose">
            ...
            <p>
              With your consent, we record pseudonymous product analytics: game
              milestones such as starting or finishing a stitching session, the
              steps of onboarding, pattern conversion and AI generation outcomes,
              purchase funnel events, and the screens you visit. These events are
              stored by us and, where you have consented, also sent to Google
              Firebase Analytics so we can see how the game is used.
            </p>
            <p>
              Analytics events carry an opaque player reference generated by us —
              never your email address, your sign-in provider identity, your
              prompts, your artwork, or your patterns. Screen records identify the
              screen only, never the specific pattern or content you opened.
              Analytics collection is switched off until you give consent in the
              consent form the App presents, we do not use advertising identifiers
              for it, we do not request App Tracking Transparency permission, and
              we perform no cross-app tracking. Firebase Analytics data is retained
              for two months; our own analytics records are retained for thirteen
              months.
            </p>
            ...
            <ul>
              ...
              <li><strong>Google Firebase Analytics</strong> — consent-based product analytics</li>
