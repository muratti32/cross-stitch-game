...
export const COPIED_ENGLISH_ALLOWLIST: CopiedEnglishAllowlist = {
  ...
  'hr:play:home.idLabel': '"ID" is used identically in Croatian tech/UI copy.',
  ...
  'sk:play:home.idLabel': '"ID" is used identically in Slovak tech/UI copy.',
  ...
  'sv:play:home.idLabel': '"ID" is used identically in Swedish tech/UI copy.',
  'sv:settings:session.idLabel': '"ID" is used identically in Swedish tech/UI copy.',
  'sv:settings:deleteModal.confirmBold': '"DELETE" is the literal confirmation keyword the user must type, kept English.',
  'sv:profile:home.identity.offline': '"Offline" is used identically in Swedish tech/UI copy.',
  'sv:create:photoImport.profile.options.standard': '"Standard" is used identically in Swedish.',
  'sv:settings:appDetails.version': '"Version" is an identical Swedish cognate.',
  'sv:settings:data.sectionTitle': '"Data" is an identical Swedish cognate.',
  'tl:play:home.idLabel': '"ID" is used identically in Tagalog tech/UI copy.',
  'tl:settings:session.idLabel': '"ID" is used identically in Tagalog tech/UI copy.',
  'tl:settings:deleteModal.confirmBold': '"DELETE" is the literal confirmation keyword the user must type, kept English.',
  'tl:settings:developer.debug.title': '"Debug" is a common English loanword in Tagalog developer UI.',
  'tl:settings:appDetails.schemeLabel': '"Scheme" is a technical URI-scheme term used identically in Tagalog developer copy.',
  'tl:create:photoImport.profile.options.standard': '"Standard" is used identically in Tagalog.',
  'tl:commerce:onetime.creditsNoun': '"Credits" is a common English loanword in Tagalog gaming UI.',
  'tl:commerce:premiumHero.benefitAiCredits': 'AI Credit is the branded in-game currency, kept English per the Tagalog pack convention.',
  'tl:profile:home.walletCard.aiCreditsLabel': 'AI Credit is the branded in-game currency, kept English per the Tagalog pack convention.',
  'tl:profile:home.identity.offline': '"Offline" is used identically in Tagalog tech/UI copy.',
  'tl:profile:publicProfile.usernameLabel': '"Username" is a common English loanword in Tagalog tech/UI copy.',
  'tl:settings:account.sectionTitle': '"Account" is a common English loanword in Tagalog tech/UI copy.',
