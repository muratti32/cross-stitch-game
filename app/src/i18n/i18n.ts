...
const resources = {
  en: { settings: enSettings, errors: enErrors, onboarding: enOnboarding, catalog: enCatalog },
  tr: { settings: trSettings, errors: trErrors, onboarding: trOnboarding, catalog: trCatalog },
};
