...
export class AddRenderStopExposureGameplayEvent1792627200000 implements MigrationInterface {
  readonly name = 'AddRenderStopExposureGameplayEvent1792627200000';

  async up(queryRunner: QueryRunner): Promise<void> {
    await replace(queryRunner, [...PREVIOUS, 'render_stop_exposure']);
  }
