...
export type EnvironmentVariables = {
  ...
  STORAGE_OBJECT_VERIFICATION_ENABLED: boolean;
  ...
  STORAGE_BUCKET_LISTING_INTERVAL_SECONDS: number;
  AI_ARTWORK_RECONCILE_INTERVAL_SECONDS: number;
  ...
  OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD: number;
  OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD: number;
  OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS: number;
  OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD: number;
  OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS: number;
  OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD: number;
...
const DEFAULT_STORAGE_BUCKET_LISTING_INTERVAL_SECONDS = 24 * 60 * 60;
const DEFAULT_AI_ARTWORK_RECONCILE_INTERVAL_SECONDS = 60;
...
const DEFAULT_OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD = 200;
const DEFAULT_OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD = 10;
const DEFAULT_OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS = 60 * 60;
const DEFAULT_OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD = 1;
const DEFAULT_OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS = 30 * 60;
const DEFAULT_OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD = 1;
...
export function parseEnvironment(
  ...
  return {
    ...
    GAMEPLAY_EVENT_RETENTION_MONTHS: parseDurationSeconds(
      environment.GAMEPLAY_EVENT_RETENTION_MONTHS,
      'GAMEPLAY_EVENT_RETENTION_MONTHS',
      DEFAULT_GAMEPLAY_EVENT_RETENTION_MONTHS,
    ),
    GAMEPLAY_EVENT_PARTITION_MAINTENANCE_INTERVAL_SECONDS: parseDurationSeconds(
      environment.GAMEPLAY_EVENT_PARTITION_MAINTENANCE_INTERVAL_SECONDS,
      'GAMEPLAY_EVENT_PARTITION_MAINTENANCE_INTERVAL_SECONDS',
      DEFAULT_GAMEPLAY_EVENT_PARTITION_MAINTENANCE_INTERVAL_SECONDS,
    ),
    RECONCILIATION_INTERVAL_SECONDS: parseDurationSeconds(
      environment.RECONCILIATION_INTERVAL_SECONDS,
      'RECONCILIATION_INTERVAL_SECONDS',
      DEFAULT_RECONCILIATION_INTERVAL_SECONDS,
    ),
    STORAGE_OBJECT_VERIFICATION_ENABLED: parseBoolean(
      environment.STORAGE_OBJECT_VERIFICATION_ENABLED,
    ...
    STORAGE_BUCKET_LISTING_INTERVAL_SECONDS: parseDurationSeconds(
      environment.STORAGE_BUCKET_LISTING_INTERVAL_SECONDS,
      'STORAGE_BUCKET_LISTING_INTERVAL_SECONDS',
      DEFAULT_STORAGE_BUCKET_LISTING_INTERVAL_SECONDS,
    ),
    AI_ARTWORK_RECONCILE_INTERVAL_SECONDS: parseDurationSeconds(
      environment.AI_ARTWORK_RECONCILE_INTERVAL_SECONDS,
      'AI_ARTWORK_RECONCILE_INTERVAL_SECONDS',
      DEFAULT_AI_ARTWORK_RECONCILE_INTERVAL_SECONDS,
    ),
    AI_CREDIT_RESERVATION_STALENESS_SECONDS: parseDurationSeconds(
      environment.AI_CREDIT_RESERVATION_STALENESS_SECONDS,
      'AI_CREDIT_RESERVATION_STALENESS_SECONDS',
      DEFAULT_AI_CREDIT_RESERVATION_STALENESS_SECONDS,
    ),
    OPERATIONAL_ALERTS_EVALUATION_INTERVAL_SECONDS: parseDurationSeconds(
      environment.OPERATIONAL_ALERTS_EVALUATION_INTERVAL_SECONDS,
      'OPERATIONAL_ALERTS_EVALUATION_INTERVAL_SECONDS',
      DEFAULT_OPERATIONAL_ALERTS_EVALUATION_INTERVAL_SECONDS,
    ),
    OPERATIONAL_ALERTS_COOLDOWN_SECONDS: parseDurationSeconds(
      environment.OPERATIONAL_ALERTS_COOLDOWN_SECONDS,
      'OPERATIONAL_ALERTS_COOLDOWN_SECONDS',
      DEFAULT_OPERATIONAL_ALERTS_COOLDOWN_SECONDS,
    ),
    OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD: parseThresholdCount(
      environment.OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD,
      'OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD',
      DEFAULT_OPERATIONAL_ALERTS_QUEUE_DEPTH_THRESHOLD,
    ),
    OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD: parseThresholdCount(
      environment.OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD,
      'OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD',
      DEFAULT_OPERATIONAL_ALERTS_WEBHOOK_FAILURE_THRESHOLD,
    ),
    OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS: parseDurationSeconds(
      environment.OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS,
      'OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS',
      DEFAULT_OPERATIONAL_ALERTS_WEBHOOK_FAILURE_WINDOW_SECONDS,
    ),
    OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD: parseThresholdCount(
      environment.OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD,
      'OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD',
      DEFAULT_OPERATIONAL_ALERTS_STUCK_JOB_THRESHOLD,
    ),
    OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS: parseDurationSeconds(
      environment.OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS,
      'OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS',
      DEFAULT_OPERATIONAL_ALERTS_STUCK_JOB_STALENESS_SECONDS,
    ),
    OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD: parseThresholdCount(
      environment.OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD,
      'OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD',
      DEFAULT_OPERATIONAL_ALERTS_PROMOTION_NEEDS_ATTENTION_THRESHOLD,
    ),
