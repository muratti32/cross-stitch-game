...
| `subscription_change_started` | `source_plan`, `target_plan`: `premium_weekly` \| `premium_monthly` \| `premium_annual`; `platform`: `ios` \| `android` |
